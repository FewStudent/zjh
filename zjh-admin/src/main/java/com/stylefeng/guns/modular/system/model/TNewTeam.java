 ...
 * @since 2019-10-07
 */
@TableName("t_new_team")
public class TNewTeam extends Model<TNewTeam> {
    ...
    @ExcelColumn(value = "送车是否有停车证（0：否 1：是）", col = 27)
    private Integer sHasStopCard;
    /**
     * 送车添加的备注信息
     */
    @TableField("s_add_remark")
    @ExcelColumn(value = "送车备注信息", col = 28)
    ...
    @ExcelColumn(value = "市内用车是否停车证（0：否 1：是）", col = 36)
    private Integer cHasStopCard;
    /**
     * 市内用车添加的备注信息
     */
    @TableField("c_add_remark")
    @ExcelColumn(value = "市内用车备注信息", col = 37)
    ...
    @ExcelColumn(value = "晚宴（0：否 1：是）", col = 38)
    ...
    @ExcelColumn(value = "自助午餐（填整数）", col = 39)
    private Integer eatLunch;
    /**
     * 工作餐（int 填数量）
     */
    @TableField("eat_work_meal")
    @ExcelColumn(value = "工作餐（填整数）", col = 40)
    private Integer eatWorkMeal;
    /**
     * 用餐支付方式（0：自费 1：公费）
     */
    @TableField("eat_pay_type")
    @ExcelColumn(value = "用餐支付方式（0：自费 1：公费）", col = 41)
    ...
    @ExcelColumn(value = "用餐备注", col = 42)
    private String eatAddRemark;
    /**
     * 用餐注意事项
     */
    @TableField("eat_attention")
    @ExcelColumn(value = "用餐注意事项", col = 43)
     ...
     */
    @ExcelColumn(value = "入住日期（2019-01-01 12:00:00）", col = 44)
    @TableField("house_in_date")
    private String houseInDate;
    /**
     * 退房日期（yyyy-MM-dd HH:mm:ss）
     */
    @ExcelColumn(value = "退房日期（2019-01-01 12:00:00）", col = 45)
    ...
    @ExcelColumn(value = "酒店名称", col = 46)
    private String hotelName;
    /**
     * 入住房间号
     */
    @TableField("hotel_room_num")
    @ExcelColumn(value = "房间号", col = 47)
    private String hotelRoomNum;
    /**
     * 房间类型
     */
    @TableField("hotel_room_type")
    @ExcelColumn(value = "房价类型", col = 48)
    private String hotelRoomType;
    /**
     * 空置床位
     */
    @TableField("hotel_vacant")
    @ExcelColumn(value = "空置床位", col = 49)
    private String hotelVacant;
    /**
     * 单价
     */
    @ExcelColumn(value = "单价（100.00）", col = 50)
    private Double price;
    /**
     * 是否拼房
     */
    @ExcelColumn(value = "是否拼房", col = 51)
    ...
    @ExcelColumn(value = "拼房人姓名", col = 52)
    private String splicePeople;
    /**
     * 房间总数
     */
    @TableField("room_total")
    @ExcelColumn(value = "房间总数", col = 53)
    private Integer roomTotal;
    /**
     * 总价（double）
     */
    @TableField("total_price")
    @ExcelColumn(value = "住房总价格", col = 54)
    private Double totalPrice;
    /**
     * 住房付费方式（0：自费 1：公费）
     */
    @TableField("house_pay_type")
    @ExcelColumn(value = "住房付费方式（0：自费 1：公费）", col = 55)
    ...
    public String toString() {
        return "TNewTeam{" +
                ...
                ", linkPhone=" + linkPhone +
                ", pickUp=" + pickUp +
                ", jUseCarDate=" + jUseCarDate +
                ", jUseCarTime=" + jUseCarTime +
                ", jTrafficNum=" + jTrafficNum +
                ", jRidePlace=" + jRidePlace +
                ", jDestination=" + jDestination +
                ", jRidePeoples=" + jRidePeoples +
                ", jAccompanyLeader=" + jAccompanyLeader +
                ", jPayType=" + jPayType +
                ", jHasStopCard = " + jHasStopCard +
                ", jAddRemark=" + jAddRemark +
                ", jCarArrange=" + jCarArrange +
                ", jDriver=" + jDriver +
                ", jDriverPhone=" + jDriverPhone +
                ", jCarCard=" + jCarCard +
                ", jCarType=" + jCarType +
                ", jCarSType=" + jCarSType +
                ", jArrangeRemark=" + jArrangeRemark +
                ", sUseCarDate=" + sUseCarDate +
                ", sUseCarTime=" + sUseCarTime +
                ", sTrafficNum=" + sTrafficNum +
                ", sRidePlace=" + sRidePlace +
                ", sDestination=" + sDestination +
                ", sRidePeoples=" + sRidePeoples +
                ", sAccompanyLeader=" + sAccompanyLeader +
                ", sPayType=" + sPayType +
                ", sHasStopCard=" + sHasStopCard +
                ", sAddRemark=" + sAddRemark +
                ", sCarArrange=" + sCarArrange +
                ", sDriver=" + sDriver +
                ", sDriverPhone=" + sDriverPhone +
                ", sCarCard = " + sCarCard +
                ", sCarType=" + sCarType +
                ", sCarSType=" + sCarSType +
                ", sArrangeRemark=" + sArrangeRemark +
                ", cUseCarDate=" + cUseCarDate +
                ", cUseCarTime=" + cUseCarTime +
                ", cRidePlace=" + cRidePlace +
                ", cDestination=" + cDestination +
                ", cRidePeoples=" + cRidePeoples +
                ", cAccompanyLeader=" + cAccompanyLeader +
                ", cPayType=" + cPayType +
                ", cHasStopCard=" + cHasStopCard +
                ", cAddRemark=" + cAddRemark +
                ", cCarArrange=" + cCarArrange +
                ", cDriver = " + cDriver + ", cDriverPhone=" + cDriverPhone +
                ", cCarCard = " + cCarCard +
                ", cCarType=" + cCarType +
                ", cCarSType=" + cCarSType +
                ", cArrangeRemark=" + cArrangeRemark +
                ", carStatus=" + carStatus +
                ", carStatusReamrkName=" + carStatusReamrkName +
                ", carStatusRemark=" + carStatusRemark +
                ", carEnd=" + carEnd +
                ", carEndRemarkName=" + carEndRemarkName +
                ", carEndRemark=" + carEndRemark +
                ", eatDinner=" + eatDinner +
                ", eatLunch=" + eatLunch +
                ", eatWorkMeal=" + eatWorkMeal +
                ", eatPayType=" + eatPayType +
                ", eatAddRemark=" + eatAddRemark +
                ", eatAttention=" + eatAttention +
                ", eatStatus=" + eatStatus +
                ", eatStatusReamrkName=" + eatStatusReamrkName +
                ", eatStatusRemark=" + eatStatusRemark +
                ", eatEnd=" + eatEnd +
                ", eatEndRemarkName=" + eatEndRemarkName +
                ", eatEndRemark=" + eatEndRemark +
                ", eatArrange=" + eatArrange +
                ", eatArrangeRemark=" + eatArrangeRemark +
                ", houseInDate=" + houseInDate +
                ", houseOutDate=" + houseOutDate +
                ", hotelName=" + hotelName +
                ", hotelRoomNum=" + hotelRoomNum +
                ", hotelRoomType=" + hotelRoomType +
                ", hotelVacant=" + hotelVacant +
                ", price=" + price +
                ", spliceRoom=" + spliceRoom +
                ", splicePeople=" + splicePeople +
                ", roomTotal=" + roomTotal +
                ", totalPrice=" + totalPrice +
                ", housePayType=" + housePayType +
                ", houseAddRemark=" + houseAddRemark +
                ", houseStatus=" + houseStatus +
                ", houseStatusReamrkName=" + houseStatusReamrkName +
                ", houseStatusRemark=" + houseStatusRemark +
                ", houseEnd=" + houseEnd +
                ", houseEndRemarkName=" + houseEndRemarkName +
                ", houseEndRemark=" + houseEndRemark +
                ", houseArrange=" + houseArrange +
                ", houseArrangeRemark=" + houseArrangeRemark +
                ", activity=" + activity +
                ...
                ", activityAddRemark=" + activityAddRemark +
                ", activityAddRemarkName=" + activityAddRemarkName +
                ", speechFile=" + speechFile +
                ", photoFile=" + photoFile +
                ", activityStatus=" + activityStatus +
                ", activityStatusReamrkName=" + activityStatusReamrkName +
                ", activityStatusRemark=" + activityStatusRemark +
                ", createBy=" + createBy +
                "}";
    }
