...
public class UserExcel {
    ...
    @ExcelColumn(value = "接车安排状态（0：未安排 1：已安排）", col = 23)
    private Integer jCarArrange;
    @ExcelColumn(value = "接车安排司机姓名", col = 24)
    private String jDriver;
    @ExcelColumn(value = "接车安排联系电话", col = 25)
    private String jDriverPhone;
    @ExcelColumn(value = "接车安排车牌号", col = 26)
    private String jCarCard;
    @ExcelColumn(value = "接车安排车类型", col = 27)
    private String jCarType;
    @ExcelColumn(value = "接车安排接送（0：未接送 1：已接送）", col = 28)
    private Integer jCarSType;
    @ExcelColumn(value = "接车安排备注内容", col = 29)
    private String jArrangeRemark;
    @ExcelColumn(value = "送车用车日期", col = 30)
    private String sUseCarDate;
    @ExcelColumn(value = "送车用车时间", col = 31)
    private String sUseCarTime;
    @ExcelColumn(value = "送车航班车次", col = 32)
    private String sTrafficNum;
    @ExcelColumn(value = "送车乘车地点", col = 33)
    private String sRidePlace;
    @ExcelColumn(value = "送车去往目的地", col = 34)
    private String sDestination;
    @ExcelColumn(value = "送车坐车人数", col = 35)
    private Integer sRidePeoples;
    @ExcelColumn(value = "送车陪同领导", col = 36)
    private String sAccompanyLeader;
    @ExcelColumn(value = "送车付费方式（0：自费 1：公费）", col = 37)
    private Integer sPayType;
    @ExcelColumn(value = "送车是否有停车证（0：否 1：是）", col = 38)
    private Integer sHasStopCard;
    @ExcelColumn(value = "送车备注信息", col = 39)
    private String sAddRemark;
    @ExcelColumn(value = "送车备注信息", col = 40)
    private Integer sCarArrange;
    @ExcelColumn(value = "送车安排司机", col = 41)
    private String sDriver;
    @ExcelColumn(value = "送车安排联系电话", col = 42)
    private String sDriverPhone;
    @ExcelColumn(value = "送车安排车牌号", col = 43)
    private String sCarCard;
    @ExcelColumn(value = "送车安排车类型", col = 44)
    private String sCarType;
    @ExcelColumn(value = "送车接送情况（0：为接送 1：已接送）", col = 45)
    private Integer sCarSType;
    @ExcelColumn(value = "送车安排备注内容", col = 46)
    private String sArrangeRemark;
    @ExcelColumn(value = "市内用车日期", col = 47)
    private String cUseCarDate;
    @ExcelColumn(value = "市内用车时间", col = 48)
    private String cUseCarTime;
    @ExcelColumn(value = "市内用车乘车地点", col = 49)
    private String cRidePlace;
    @ExcelColumn(value = "市内用车去往目的地", col = 50)
    private String cDestination;
    @ExcelColumn(value = "市内用车坐车人数", col = 51)
    private Integer cRidePeoples;
    @ExcelColumn(value = "市内用车陪同领导", col = 52)
    private String cAccompanyLeader;
    @ExcelColumn(value = "市内用车付费方式（0：自费 1：公费）", col = 53)
    private Integer cPayType;
    @ExcelColumn(value = "市内用车是否停车证（0：否 1：是）", col = 54)
    private Integer cHasStopCard;
    @ExcelColumn(value = "市内用车备注信息", col = 55)
    private String cAddRemark;
    @ExcelColumn(value = "市内用车安排状态（0：未安排 1：已安排）", col = 56)
    private Integer cCarArrange;
    @ExcelColumn(value = "市内用车安排司机", col = 57)
    private String cDriver;
    @ExcelColumn(value = "市内用车安排联系电话", col = 58)
    private String cDriverPhone;
    @ExcelColumn(value = "市内用车安排车牌号", col = 59)
    private String cCarCard;
    @ExcelColumn(value = "市内用车安排车类型", col = 60)
    private String cCarType;
    @ExcelColumn(value = "市内用车接送情况（0：未接送 1：已接送）", col = 61)
    private Integer cCarSType;
    @ExcelColumn(value = "市内用车安排备注内容", col = 62)
    private String cArrangeRemark;
    @ExcelColumn(value = "市内用车审核状态（0：未审核 1：已审核 2：已退回）", col = 63)
    private Integer carStatus;
    @ExcelColumn(value = "用车审核备注人", col = 64)
    private String carStatusReamrkName;
    @ExcelColumn(value = "市内用车备注内容", col = 65)
    private String carStatusRemark;
    @ExcelColumn(value = "用车结束状态（0：未结束 1：已结束）", col = 66)
    private Integer carEnd;
    @ExcelColumn(value = "市内用车结束备注人", col = 67)
    private String carEndRemarkName;
    @ExcelColumn(value = "市内用车结束备注信息", col = 68)
    private String carEndRemark;
    @ExcelColumn(value = "晚宴（0：否 1：是）", col = 69)
    private Integer eatDinner;
    @ExcelColumn(value = "自助午餐", col = 70)
    private Integer eatLunch;
    @ExcelColumn(value = "工作餐", col = 71)
    private Integer eatWorkMeal;
    @ExcelColumn(value = "用餐支付方式（0：自费 1：公费）", col = 72)
    private Integer eatPayType;
    @ExcelColumn(value = "用餐备注", col = 73)
    private String eatAddRemark;
    @ExcelColumn(value = "用餐注意事项", col = 74)
    private String eatAttention;
    @ExcelColumn(value = "用餐审核状态（0：未审核 1：已审核 2：已退回）", col = 75)
    private Integer eatStatus;
    @ExcelColumn(value = "用餐审核备注人", col = 76)
    private String eatStatusReamrkName;
    @ExcelColumn(value = "用餐审核备注信息", col = 77)
    private String eatStatusRemark;
    @ExcelColumn(value = "用餐结束状态（0：未结束 1：已结束）", col = 78)
    private Integer eatEnd;
    @ExcelColumn(value = "用餐结束备注人", col = 79)
    private String eatEndRemarkName;
    @ExcelColumn(value = "用餐结束备注信息", col = 80)
    private String eatEndRemark;
    @ExcelColumn(value = "用餐安排状态（0：未安排 1：已安排）", col = 81)
    private Integer eatArrange;
    @ExcelColumn(value = "用餐安排备注内容", col = 82)
    private String eatArrangeRemark;
    @ExcelColumn(value = "入住日期", col = 83)
    private String houseInDate;
    @ExcelColumn(value = "退房日期", col = 84)
    private String houseOutDate;
    @ExcelColumn(value = "酒店名称", col = 85)
    private String hotelName;
    @ExcelColumn(value = "房价类型", col = 86)
    private String hotelRoomType;
    @ExcelColumn(value = "空置床位", col = 87)
    private String hotelVacant;
    @ExcelColumn(value = "单价", col = 88)
    private Double price;
    @ExcelColumn(value = "是否拼房", col = 89)
    private String spliceRoom;
    @ExcelColumn(value = "拼房人姓名", col = 90)
    private String splicePeople;
    @ExcelColumn(value = "房间总数", col = 91)
    private Integer roomTotal;
    @ExcelColumn(value = "住房总价格", col = 92)
    private Double totalPrice;
    @ExcelColumn(value = "住房付费方式（0：自费 1：公费）", col = 93)
    private Integer housePayType;
    @ExcelColumn(value = "住房备注", col = 94)
    private String houseAddRemark;
    @ExcelColumn(value = "住房审核状态", col = 95)
    private Integer houseStatus;
    @ExcelColumn(value = "住房审核备注人", col = 96)
    private String houseStatusReamrkName;
    @ExcelColumn(value = "住房审核备注信息", col = 97)
    private String houseStatusRemark;
    @ExcelColumn(value = "住房结束状态（0：未结束 1：已结束）", col = 98)
    private Integer houseEnd;
    @ExcelColumn(value = "住房结束被主人", col = 99)
    private String houseEndRemarkName;
    @ExcelColumn(value = "住房结束备注", col = 100)
    private String houseEndRemark;
    @ExcelColumn(value = "住房安排状态（0：未安排 1：已安排）", col = 101)
    private Integer houseArrange;
    @ExcelColumn(value = "住房安排备注内容", col = 102)
    private String houseArrangeRemark;
    @ExcelColumn(value = "房间号", col = 103)
    private String hotelRoomNum;
    @ExcelColumn(value = "开户姓名", col = 104)
    private String accountName;
    @ExcelColumn(value = "开户银行", col = 105)
    private String accountBlank;
    @ExcelColumn(value = "开户账号", col = 106)
    private String account;
    @ExcelColumn(value = "个人简介", col = 107)
    private String personalSynopsis;
    @ExcelColumn(value = "个人角色（0：主持人 1：演讲嘉宾 2：观众）", col = 108)
    private Integer role;
    @ExcelColumn(value = "演讲主题", col = 109)
    private String speechTopic;
    @ExcelColumn(value = "活动备注", col = 110)
    private String activityAddRemark;
    @ExcelColumn(value = "活动备注人", col = 111)
    private String activityAddRemarkName;
    @ExcelColumn(value = "活动审核状态（0：未审核 1：已审核 2：已退回）", col = 112)
    private Integer activityStatus;
    @ExcelColumn(value = "活动审核备注人", col = 113)
    private String activityStatusReamrkName;
    @ExcelColumn(value = "活动审核备注信息", col = 114)
    private String activityStatusRemark;
    @ExcelColumn(value = "参与活动", col = 115)
