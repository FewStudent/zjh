...
public class RoleController extends BaseController {
    ...
    public List<ZTreeNode> roleTreeListByUserId(@PathVariable Integer userId) {
        ...
        if (ToolUtil.isEmpty(roleid)) {
            ...
            for (int i = 0; i < roleTreeListByUserId.size(); i++) {
                ZTreeNode zTreeNode = roleTreeListByUserId.get(0);
                if (zTreeNode.getId().intValue() == 1) {
                    roleTreeListByUserId.remove(zTreeNode);
                }
            }
